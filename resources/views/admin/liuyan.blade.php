            ...
            <div class="banShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="315px" class="tdColor">昵称</td>
                    ...
                    @foreach($info as $k=>$v)
                        <tr>
                            ...
                            <td>{{$v->msg_name}}</td>
                            <td>{{$v->msg_content}}</td>
                            <td><a href="/admin/editmessages/{{$v->msg_id}}"><img class="operation"
                                                                        src="/img/update.png"></a> <img class="operation delban"
                                                                                                        src="/img/delete.png" data-id="{{$v->msg_id}}"></td>
                        </tr>
                    @endforeach
                </table>
