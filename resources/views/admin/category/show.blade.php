...
<div id="pageAll">
    ...
    <div class="page">
        ...
        <div class="banner">
            <div class="add">
                <a class="addA" href="/admin/category">添加分类&nbsp;&nbsp;+</a>
            </div>
            <!-- banner 表格 显示 -->
            <div class="banShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($info as $k=>$v)
                        <tr cate_id="{{$v->cate_id}}">
                            <td>{{$v->cate_id}}</td>
                            <td><span class="cate_name">{{$v->cate_name}}</span>
                                <input type="text" value="{{$v->cate_name}}" class="editname" style="display:none" cate_id="{{$v->cate_id}}"></td>
                            <td>
                            <span class="is_show">
                                @if($v->is_show == 1)
                                    是
                            ...
                            <td><a href="/admin/editcategory/{{$v->cate_id}}"><img class="operation"
                                                                        src="/img/update.png"></a> <img class="operation delban"
                                                                                                        src="/img/delete.png" data-id="{{$v->cate_id}}"></td>
                        </tr>
                    @endforeach
                </table>
