...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="{{url('admin/guide/add')}}">添加导航栏&nbsp;&nbsp;+</a>
				</div>
				<!-- banner 表格 显示 -->
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr gui_id="{{$v->id}}">
							...
							<td><span class="sorts">{{$v->sorts}}</span><input type="text" value="{{$v->sorts}}" class="editsorts" style="display:none" gui_id="{{$v->id}}"></td>
							<td><a href="/admin/guide/upd/{{$v->id}}"><img class="operation"
									src="/admin/img/update.png"></a> 
									<img class="operation delban"
								src="/admin/img/delete.png" data-id="{{$v->id}}"></td>
						</tr>
						@endforeach
					</table>
