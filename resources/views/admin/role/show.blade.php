...
<div id="pageAll">
    ...
    <div class="page">
        ...
        <div class="banner">
            <div class="add">
                <a class="addA" href="/admin/role">添加角色&nbsp;&nbsp;+</a>
            </div>
            <!-- banner 表格 显示 -->
            <div class="banShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="315px" class="tdColor">角色名称</td>
                        <td width="315px" class="tdColor">权限操作</td>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($p_data as $kk=>$vv)
                                ...
                                @endif
                            @endforeach
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="bsA" href="/admin/roleright/{{$v->role_id}}">+</a></td>
                        <td><a href="/admin/editrole/{{$v->role_id}}">
                                <img class="operation" src="/img/update.png"></a>
                            <img class="operation delban" src="/img/delete.png" data-id="{{$v->role_id}}"></td>
                    </tr>
                    @endforeach
                </table>
